...
function createEmojiGroup(emojis: Record<string, string[]>): Record<string, string[]> {
  return emojis;
}
...
export const emojiSearchMap: Record<string, string[]> = {
  ...
  // ============================================
  "😀": ["grin", "happy", "smile", "joy", "cheerful", "glad", "face", "teeth", "big smile"],
  ...
  "🤨": ["raised eyebrow", "skeptical", "doubt", "question", "suspicious", "really"],
  ...
  "🍠": ["sweet potato", "roasted", "japanese", "orange"],
  ...
  "🦀": ["crab", "seafood", "shellfish", "claws", "red"],
  "🦞": ["lobster", "seafood", "shellfish", "expensive", "red"],
  "🦐": ["shrimp", "prawn", "seafood", "small", "pink"],
  "🦑": ["squid", "calamari", "seafood", "tentacles", "ocean"],
  ...
  // Travel & Places
  "🌍": ["earth africa", "globe", "world", "planet", "international", "global", "africa", "europe"],
  "🌎": ["earth americas", "globe", "world", "planet", "western", "america", "usa", "canada"],
  "🌏": ["earth asia", "globe", "world", "planet", "eastern", "asia", "australia", "pacific"],
  "🌐": ["globe meridians", "world", "international", "www", "internet", "web", "global", "network"],
  "🗺️": ["world map", "geography", "travel", "navigation", "atlas", "cartography", "location"],
  "🗾": ["japan map", "country", "island", "asia", "silhouette", "nippon", "japanese"],
  "🧭": ["compass", "direction", "navigation", "north", "travel", "navigate", "orientation"],
  "🏔️": ["mountain", "snow", "peak", "hiking", "tall", "alps", "summit", "snowy"],
  "⛰️": ["mountain", "hiking", "nature", "peak", "climb", "hill", "trek", "mountaineering"],
  "🌋": ["volcano", "eruption", "lava", "hot", "mountain", "magma", "erupt", "volcanic"],
  "🗻": ["mount fuji", "japan", "mountain", "snow", "sacred", "fuji", "japanese mountain"],
  "🏕️": ["camping", "tent", "outdoors", "nature", "adventure", "camp", "wilderness", "campsite"],
  "🏖️": ["beach", "umbrella", "vacation", "sand", "ocean", "seaside", "coast", "holiday"],
  "🏜️": ["desert", "cactus", "hot", "dry", "sand", "sahara", "arid", "dune"],
  "🏝️": ["island", "tropical", "palm tree", "vacation", "paradise", "deserted island", "caribbean"],
  "🏞️": ["national park", "nature", "landscape", "scenery", "outdoors", "park", "scenic", "vista"],
  
  // Buildings & Architecture
  "🏟️": ["stadium", "sports", "arena", "venue", "colosseum", "football", "concert"],
  "🏛️": ["classical building", "museum", "greek", "columns", "architecture", "government", "temple"],
  "🏗️": ["construction", "building", "crane", "work", "site", "development", "build"],
  "🧱": ["brick", "wall", "construction", "build", "masonry", "block", "material"],
  "🏘️": ["houses", "neighborhood", "suburb", "residential", "community", "village", "homes"],
  "🏚️": ["derelict house", "abandoned", "old", "ruined", "broken", "haunted", "decrepit"],
  "🏠": ["house", "home", "building", "residence", "dwelling", "household", "family"],
  "🏡": ["house garden", "home", "yard", "cottage", "suburban", "property", "residence"],
  "🏢": ["office", "building", "business", "work", "corporate", "company", "skyscraper"],
  "🏣": ["japanese post office", "mail", "postal", "japan", "correspondence", "letter"],
  "🏤": ["post office", "mail", "postal", "letters", "package", "correspondence", "europe"],
  "🏥": ["hospital", "medical", "health", "emergency", "clinic", "healthcare", "doctor"],
  "🏦": ["bank", "money", "finance", "building", "financial", "savings", "institution"],
  "🏨": ["hotel", "accommodation", "lodging", "stay", "vacation", "hospitality", "inn"],
  "🏩": ["love hotel", "romance", "heart", "accommodation", "japanese", "couples"],
  "🏪": ["convenience store", "shop", "24/7", "market", "retail", "minimart", "open"],
  "🏫": ["school", "education", "building", "learn", "study", "academic", "classroom"],
  "🏬": ["department store", "shopping", "mall", "retail", "commerce", "shop", "store"],
  "🏭": ["factory", "industrial", "manufacturing", "production", "industry", "plant", "smoke"],
  "🏯": ["japanese castle", "pagoda", "fortress", "historic", "architecture", "samurai"],
  "🏰": ["castle", "fortress", "medieval", "palace", "kingdom", "royal", "fairy tale"],
  "💒": ["wedding", "church", "chapel", "marriage", "ceremony", "love", "romance"],
  "🗼": ["tokyo tower", "landmark", "japan", "tourist", "observation", "red tower"],
  "🗽": ["statue of liberty", "new york", "usa", "freedom", "america", "landmark", "liberty"],
  "⛪": ["church", "christian", "religion", "worship", "chapel", "cathedral", "cross"],
  "🕌": ["mosque", "islam", "muslim", "worship", "religion", "minaret", "prayer"],
  "🛕": ["hindu temple", "mandir", "worship", "religion", "india", "hinduism", "spiritual"],
  "🕍": ["synagogue", "jewish", "temple", "worship", "judaism", "star of david"],
  "⛩️": ["shinto shrine", "torii", "japan", "gate", "religious", "spiritual", "red gate"],
  "🕋": ["kaaba", "mecca", "islam", "muslim", "hajj", "pilgrimage", "holy"],
  
  // Transportation
  "🚂": ["locomotive", "train", "steam", "railway", "engine", "railroad", "choo choo"],
  "🚃": ["railway car", "train", "carriage", "rail", "transport", "passenger", "coach"],
  "🚄": ["high speed train", "bullet train", "shinkansen", "fast", "railway", "japan"],
  "🚅": ["bullet train", "shinkansen", "fast", "railway", "speed", "express", "rapid"],
  "🚆": ["train", "railway", "metro", "subway", "transport", "commute", "rail"],
  "🚇": ["metro", "subway", "underground", "tube", "train", "urban", "transport"],
  "🚈": ["light rail", "tram", "streetcar", "public transport", "city", "commute"],
  "🚉": ["station", "train station", "railway", "platform", "depot", "terminal", "stop"],
  "🚊": ["tram", "streetcar", "trolley", "public transport", "city", "rail"],
  "🚝": ["monorail", "train", "elevated", "transport", "railway", "single rail"],
  "🚞": ["mountain railway", "cable car", "funicular", "train", "steep", "incline"],
  "🚋": ["tram car", "streetcar", "trolley", "carriage", "public transport"],
  "🚌": ["bus", "public transport", "coach", "transit", "school bus", "vehicle"],
  "🚍": ["bus front", "oncoming bus", "transport", "vehicle", "approaching", "public"],
  "🚎": ["trolleybus", "electric bus", "public transport", "city", "eco", "green"],
  "🚐": ["minibus", "van", "shuttle", "transport", "vehicle", "small bus"],
  "🚑": ["ambulance", "emergency", "medical", "hospital", "rescue", "emt", "911"],
  "🚒": ["fire engine", "fire truck", "emergency", "rescue", "firefighter", "ladder"],
  "🚓": ["police car", "cop", "patrol", "law enforcement", "emergency", "cruiser"],
  "🚔": ["police car front", "oncoming", "cop", "law", "patrol", "approaching"],
  "🚕": ["taxi", "cab", "ride", "transport", "yellow cab", "hire", "fare"],
  "🚖": ["taxi front", "oncoming taxi", "cab", "approaching", "ride", "transport"],
  "🚗": ["car", "automobile", "vehicle", "drive", "sedan", "red car", "auto"],
  "🚘": ["car front", "oncoming", "automobile", "approaching", "vehicle", "drive"],
  "🚙": ["suv", "recreational vehicle", "rv", "camping", "road trip", "4x4"],
  "🚚": ["delivery truck", "lorry", "shipping", "cargo", "freight", "transport"],
  "🚛": ["articulated lorry", "semi", "truck", "18 wheeler", "big rig", "hauler"],
  "🚜": ["tractor", "farm", "agriculture", "farming", "vehicle", "rural", "harvest"],
  "🏎️": ["racing car", "f1", "formula one", "speed", "race", "fast", "motorsport"],
  "🏍️": ["motorcycle", "motorbike", "bike", "ride", "speed", "biker", "harley"],
  "🛵": ["motor scooter", "vespa", "moped", "transport", "urban", "delivery"],
  "🛺": ["auto rickshaw", "tuk tuk", "three wheeler", "taxi", "india", "transport"],
  ...
  "🛤️": ["railway track", "railroad", "train tracks", "rails", "transportation"],
  "🛢️": ["oil drum", "barrel", "petroleum", "fuel", "energy", "container"],
  "⛽": ["fuel pump", "gas station", "petrol", "gasoline", "refuel", "fill up"],
  "🚨": ["police car light", "siren", "emergency", "alert", "warning", "beacon"],
  ...
  "🛫": ["airplane departure", "takeoff", "flight", "leaving", "airport", "ascend"],
  "🛬": ["airplane arrival", "landing", "flight", "arriving", "airport", "descend"],
  ...
  "🌦️": ["sun behind rain cloud", "sun shower", "weather", "mixed", "partly rainy"],
  "🌧️": ["cloud with rain", "rainy", "weather", "precipitation", "wet", "shower"],
  "⛈️": ["cloud with lightning and rain", "thunderstorm", "storm", "weather", "thunder"],
  ...
  "💨": ["dash", "wind", "fast", "speed", "smoke", "poof", "air"],
  ...
  "💦": ["sweat drops", "water", "splash", "wet", "droplets", "spray"],
  "☔": ["umbrella with rain", "rainy", "weather", "protection", "wet"],
  ...
  "⚡": ["lightning", "electricity", "thunder", "bolt", "power", "shock", "fast"],
  "🔥": ["fire", "hot", "flame", "burn", "lit", "heat", "spicy"],
  "💥": ["explosion", "boom", "bang", "blast", "collision", "impact", "pow"],
  ...
  "🪛": ["screwdriver", "tool", "screw", "fix", "repair", "phillips", "flathead"],
  ...
  "🔌": ["electric plug", "power", "socket", "electricity", "connect", "charge"],
  ...
  // Symbols & Signs
  "❤️": ["red heart", "love", "romance", "passion", "valentine", "heart", "like"],
  "🧡": ["orange heart", "love", "warm", "care", "friendship", "fall"],
  "💛": ["yellow heart", "love", "friendship", "happy", "gold", "bestie"],
  "💚": ["green heart", "love", "nature", "environment", "jealous", "eco"],
  "💙": ["blue heart", "love", "trust", "loyalty", "peace", "water"],
  "💜": ["purple heart", "love", "bts", "army", "violet", "luxury"],
  "🖤": ["black heart", "love", "dark", "goth", "emo", "death"],
  "🤍": ["white heart", "love", "pure", "clean", "peace", "innocent"],
  "🤎": ["brown heart", "love", "chocolate", "earth", "skin", "coffee"],
  "❤️‍🔥": ["heart on fire", "passion", "lust", "burning love", "intense"],
  "❤️‍🩹": ["mending heart", "healing", "recovery", "getting better", "bandage"],
  "💔": ["broken heart", "sad", "breakup", "hurt", "pain", "heartbreak"],
  "❣️": ["exclamation heart", "love", "emphasis", "strong", "excited"],
  "💕": ["two hearts", "love", "couple", "together", "romance", "affection"],
  "💞": ["revolving hearts", "love", "dance", "together", "couple", "spinning"],
  "💓": ["beating heart", "pulse", "love", "heartbeat", "alive", "excited"],
  "💗": ["growing heart", "love", "pink", "increase", "more", "expanding"],
  "💖": ["sparkling heart", "love", "shiny", "glitter", "special", "magical"],
  "💘": ["cupid heart", "heart arrow", "love", "romance", "valentine", "struck"],
  "💝": ["heart ribbon", "gift", "love", "present", "valentine", "box"],
  "♈": ["aries", "zodiac", "ram", "astrology", "march", "april", "fire sign"],
  ...
  "♍": ["virgo", "zodiac", "maiden", "astrology", "august", "september", "earth sign"],
  "♎": ["libra", "zodiac", "scales", "astrology", "september", "october", "air sign"],
  "♏": ["scorpio", "zodiac", "scorpion", "astrology", "october", "november", "water sign"],
  "♐": ["sagittarius", "zodiac", "archer", "astrology", "november", "december", "fire sign"],
  "♑": ["capricorn", "zodiac", "goat", "astrology", "december", "january", "earth sign"],
  "♒": ["aquarius", "zodiac", "water bearer", "astrology", "january", "february", "air sign"],
  "♓": ["pisces", "zodiac", "fish", "astrology", "february", "march", "water sign"],
  "⛎": ["ophiuchus", "zodiac", "serpent", "astrology", "13th sign", "snake bearer"],
  ...
  "🇺🇸": ["usa flag", "america", "united states", "us", "american", "stars and stripes"],
  "🇬🇧": ["uk flag", "britain", "england", "united kingdom", "british", "union jack"],
  ...
  // Activities & Events
  "🎃": ["jack-o-lantern", "halloween", "pumpkin", "spooky", "october", "carved"],
  ...
  "🎏": ["carp streamer", "koinobori", "children's day", "japanese", "fish flag"],
  ...
  "🥼": ["lab coat", "doctor", "scientist", "medical", "white coat", "professional"],
  ...
  "🎓": ["graduation cap", "mortarboard", "graduate", "college", "degree", "education"],
  "🧢": ["billed cap", "baseball cap", "hat", "casual", "sport", "snapback"],
  "🪖": ["military helmet", "army", "soldier", "combat", "war", "protection"],
  "⛑️": ["rescue helmet", "safety", "emergency", "red cross", "help", "medical"],
  ...
  "🎵": ["music note", "music", "sound", "melody", "eighth note", "quaver"],
  "🎶": ["music notes", "melody", "song", "tune", "multiple notes"],
  "💹": ["chart increasing yen", "graph", "growth", "finance", "profit", "trending up"],
  ...
  "🚺": ["women's room", "bathroom", "restroom", "toilet", "female", "lavatory"],
  ...
  "🚫": ["prohibited", "no", "forbidden", "not allowed", "banned", "circle slash"],
  "🚳": ["no bicycles", "prohibited", "bikes", "forbidden", "cycling banned"],
  "🚭": ["no smoking", "prohibited", "cigarette", "forbidden", "smoke free"],
  "🚯": ["no littering", "prohibited", "trash", "forbidden", "keep clean"],
  "🚱": ["non-potable water", "unsafe", "do not drink", "contaminated"],
  "🚷": ["no pedestrians", "prohibited", "walking", "forbidden", "no access"],
  "📵": ["no mobile phones", "prohibited", "silence", "forbidden", "no calls"],
  "🔞": ["no one under 18", "adults only", "mature", "age restriction", "nsfw"],
  ...
  "✡️": ["star of david", "jewish", "judaism", "israel", "religion", "hexagram"],
  ...
  "♉": ["taurus", "zodiac", "bull", "april", "may", "astrology", "horoscope"],
  "♊": ["gemini", "zodiac", "twins", "may", "june", "astrology", "horoscope"],
  "♋": ["cancer", "zodiac", "crab", "june", "july", "astrology", "horoscope"],
  "♌": ["leo", "zodiac", "lion", "july", "august", "astrology", "horoscope"],
  "♍": ["virgo", "zodiac", "maiden", "august", "september", "astrology", "horoscope"],
  "♎": ["libra", "zodiac", "scales", "september", "october", "astrology", "horoscope"],
  "♏": ["scorpio", "zodiac", "scorpion", "october", "november", "astrology", "horoscope"],
  "♐": ["sagittarius", "zodiac", "archer", "november", "december", "astrology", "horoscope"],
  "♑": ["capricorn", "zodiac", "goat", "december", "january", "astrology", "horoscope"],
  "♒": ["aquarius", "zodiac", "water bearer", "january", "february", "astrology", "horoscope"],
  "♓": ["pisces", "zodiac", "fish", "february", "march", "astrology", "horoscope"],
  "⛎": ["ophiuchus", "zodiac", "serpent bearer", "13th sign", "astrology"],
  "🔀": ["shuffle tracks", "random", "music", "mix", "playlist"],
